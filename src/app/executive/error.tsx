...
export default function ExecutiveError({
  ...
  useEffect(() => {
    console.error('[Executive ErrorBoundary]', error);
  }, [error]);
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center gap-6 safe-top safe-bottom" role="alert">
      ...
      <div className="space-y-2 max-w-sm">
        ...
        <p className="text-base text-muted-foreground">
          The executive workspace hit an unexpected error. Your data is safe — please reload to continue.
        </p>
        {error.digest && (
      ...
      <div className="flex gap-3">
        ...
        <Button variant="outline" onClick={() => (window.location.href = '/executive/workspace')}>
          Workspace
        </Button>
      </div>
    </div>
