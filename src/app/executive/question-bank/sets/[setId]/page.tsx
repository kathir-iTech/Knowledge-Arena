...
function SourceBadge({ source }: { source: string }) {
  ...
  return (
    <Badge variant="outline" className={cn('text-[10px] h-5', isForge ? 'text-amber-600 bg-amber-50 dark:bg-amber-950/20 border-amber-200 dark:border-amber-800' : 'text-blue-600 bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800')}>
                      ...
                      {q.options.map((opt, oi) => (
                        <div key={oi} className={cn(
                          ...
                          <div className={cn(
                            ...
                            q.correctAnswerIndex === oi ? 'bg-emerald-500 text-white' : 'bg-background text-muted-foreground'
                          )}>
