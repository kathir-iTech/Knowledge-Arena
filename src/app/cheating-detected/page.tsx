    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-4 text-center animate-in gap-6 safe-top safe-bottom">
      ...
      <div className="space-y-2 max-w-sm">
        ...
        <p className="text-base text-muted-foreground">
          Your attempt to enter the arena was denied. This can happen if you try to join a room you are not authorized to access.
        </p>
      </div>
      <p className="text-base text-muted-foreground max-w-sm">
        Please contact your Commander if you believe this is an error.
      </p>
