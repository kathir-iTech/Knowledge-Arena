...
// The implementation lives on in src/ai/engines/knowledge-engine.ts (source
// intentionally kept for future wiring). Endpoint intentionally responds
// "not available" instead of running the Genkit engine.
//
...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    { error: 'Not available', message: 'The Knowledge engine is shelved and not available for use.' },
    { status: 410 }
  );
}