...
const MODELS: GeminiModel[] = [
  {
    ...
    description: 'Fastest model for high-volume quiz generation',
    generation: 3.5,
    category: 'flash-lite',
    speed: 5,
    reasoning: 3,
    ...
    deprecated: false,
    available: true,
    bestFor: 'High-volume quiz generation, low-latency tasks',
    badges: ['⚡ Fastest', '🆕 Latest'],
  },
  {
    id: 'gemini-3.1-flash-lite',
    displayName: 'Gemini 3.1 Flash-Lite',
    description: 'Ultra high throughput, cost-efficient',
    generation: 3.1,
    category: 'flash-lite',
    speed: 4,
    reasoning: 3,
    ...
    deprecated: false,
    available: true,
    bestFor: 'Batch processing, cost-sensitive workloads',
