...
const LAYERS = [
  {
    ...
    text: 'Three role-based portals (Gladiator, Commander, Executive) with route-level guards and middleware.',
  },
  {
    icon: Database,
      ...
      <Reveal className="mt-10 overflow-x-auto">
        <div className="mx-auto flex min-w-[640px] flex-col items-stretch gap-3 lg:flex-row lg:items-center lg:justify-center">
          <div className="rounded-2xl border bg-card p-4 shadow-elevation-small">
            <p className="text-center text-xs font-semibold uppercase tracking-wide text-muted-foreground">Users</p>
...
const TEAM = [
  ...
  { initials: 'RB', name: 'Ravi Bhatt', role: 'Engineering Lead', gradient: 'from-rose-500 to-orange-400' },
  { initials: 'MC', name: 'Mira Chen', role: 'AI / ML Engineer', gradient: 'from-sky-500 to-indigo-400' },
  { initials: 'TD', name: 'Tom Delgado', role: 'Design Lead', gradient: 'from-emerald-500 to-teal-400' },
  { initials: 'SO', name: 'Sana Omar', role: 'Educator Advisor', gradient: 'from-amber-500 to-orange-400' },
];
    ...
    <section id="team" className="border-y bg-secondary/40">
      <div className="page-container py-16 md:py-20">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 font-headline text-3xl font-bold tracking-tight text-balance sm:text-4xl">
            Built by people who love classrooms
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
            Engineers, educators, and designers shipping a battle-tested learning product.
          </p>
        </Reveal>
    ...
    <section className="page-container py-16 md:py-20">
      <Reveal>
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-accent p-8 text-center shadow-elevation-large sm:p-12">
          <div className="pointer-events-none absolute inset-0 animate-gradient opacity-40" aria-hidden="true"
          ...
          <div className="relative">
            <h2 className="mx-auto max-w-2xl font-headline text-3xl font-bold tracking-tight text-primary-foreground text-balance sm:text-4xl">
              The bell rings in 5 minutes. Are your students ready?
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-primary-foreground/85 sm:text-base">
              Launch a live battle, watch the leaderboard move, and see learning happen
              in real time.
            </p>
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                href="#demo"
                className="inline-flex h-12 items-center rounded-[12px] bg-primary-foreground px-6 text-base font-semibold text-primary shadow-elevation-medium transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground"
              >
                Start the one-click demo
              </a>
              <a
                href="/login"
                className="inline-flex h-12 items-center rounded-[12px] border border-primary-foreground/40 px-6 text-base font-semibold text-primary-foreground transition-colors hover:bg-primary-foreground/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground"
              >
